...
// get limited featured products
  ...
  Future<List<ProductModel>> getFavoriteProducts(List<String> products) async {
    try {
 final snapshot = await _db.collection("Products").where(FieldPath.documentId,whereIn: products).get();
